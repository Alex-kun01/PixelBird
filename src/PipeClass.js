const gameWidth = gameDom.clientWidth;//game的宽度

class Pipe extends Parents{
...
class PipePare {
    constructor(speed){
        ...
        this.maxHeight = landTop - this.spaceHeight;
        const upHeight = getRandom(this.minHeight, this.maxHeight);//上水管的随即高度
        ...
        const downHeight = landTop - upHeight - this.spaceHeight; //下水管的随即高度
